        ...
        <div className="aboutUs">
            <div className="about-main">
                ...
                <div className="about-items">
                    <div className="about-left">
                        <div className="about-detail">
                            <h2>Our Aim Is To Provide Best In Quality</h2>
                    ...
                    <div className="aboutPage-right">
                        <div className="aboutPage-card">
                            <div className="aboutPage-card-btn">
                                <Link to={"/krugervac/contact-us"}>Get a Quote</Link>
                            </div>
                            <h4>Our Vision for Industry</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam, facere.</p>
                        </div>
                        <div className="aboutPage-card">
                            <div className="aboutPage-card-btn">
                                <Link to={"/krugervac/contact-us"}>Contact Us</Link>
                            </div>
